...
public class Globals {
    ...
    public static int screenWidth = (int) Toolkit.getDefaultToolkit().getScreenSize().getWidth(), screenHeight = (int) Toolkit.getDefaultToolkit().getScreenSize().getHeight(), currentItemType = 6, currentLevel = 0, currentWorld = 0, numberOfWorldsOpen = 0, tabWidth = 0;
    ...
    public static boolean levelUpKeyIsDown = false, levelDownKeyIsDown = false, saveKeyIsDown = false, painting = true, canDraw = false;
