...
int main() {
	...
	while (window.isOpen()) {
		...
		if (sf::Mouse::isButtonPressed(sf::Mouse::Right)) {
			...
			BaseClass* bullet = new Bullet(worldManager.getCurrentWorld(), textureManager.getTextureFor(BULLET, 0), bulletLocation.getGrid(), bulletLocation.getPoint(), 10, angle);
		}
